...
string standardPath = "../template.jpg";
...
int main(int argc, char **argv) {
    int action;
    cout << "Enter '1': Show positive example." << endl;
    cout << "Enter '2': Show negative example." << endl;
    cout << "Enter '3': Test your own image." << endl;
    cin >> action;
    string originPath;
    if (action == 1) {
        originPath = "../image/IMG_9696.JPG";
    } else if (action == 2) {
        originPath = "../image/IMG_9697.JPG";
    } else if (action == 3) {
